...
(function initLiveSearch(){
  ...
  const sitePages = [
    { name: 'Marketplace', url: '/pages/marketplace/marketplace.html', keywords: ['market','mkt','buy','sell'] },
    { name: 'Crop Calendar', url: '/pages/farming/cropCalendar.html', keywords: ['calendar','schedule','crop plan','planting'] },
    { name: 'Crop Advisory', url: '/pages/farming/crop_advisory.html', keywords: ['advice','advisory','advisor','agronomy'] },
    { name: 'AI Disease Detection', url: '/pages/farming/ai_disease.html', keywords: ['disease','diagnose','ai','pest'] },
    { name: 'Equipment Supply', url: '/pages/marketplace/equipments.html', keywords: ['equipment','tractor','rental','tools'] },
    { name: 'Loan Dashboard', url: '/pages/dashboards/loan_dashboard.html', keywords: ['loan','finance','credit'] },
    { name: 'Insurance Portal', url: '/pages/finance/insurance_portal.html', keywords: ['insurance','cover','claims'] },
    { name: 'Knowledge Hub', url: '/pages/community/knowledge_hub.html', keywords: ['learn','knowledge','howto','guides'] },
    { name: 'Farm Dashboard', url: '/pages/dashboards/farm_dashboard.html', keywords: ['dashboard','farm','overview'] },
    { name: 'News', url: '/pages/news.html', keywords: ['news','updates','market news'] },
    { name: 'Careers', url: '/pages/misc/careers.html', keywords: ['jobs','career','hiring'] },
    { name: 'Blog', url: '/pages/blog.html', keywords: ['blog','articles','stories'] },
    { name: 'Forum', url: '/pages/community/community_forum.html', keywords: ['forum','community','discuss'] },
    { name: 'Contact', url: '/pages/contact.html', keywords: ['contact','support','help'] },
    { name: 'Login', url: '/pages/auth/login.html', keywords: ['login','sign in','signin'] }
  ];
