...
from server.Routes.irrigation_routes import irrigation_bp
...
@app.route('/farmer')
def farmer():
    return send_from_directory('public/pages/dashboards', 'farmer.html')

@app.route('/shopkeeper')
def shopkeeper():
    return send_from_directory('public/pages/dashboards', 'shopkeeper.html')

@app.route('/main')
def main():
    return send_from_directory('public/pages', 'main.html')

@app.route('/about')
def about():
    return send_from_directory('public/pages', 'about.html')

@app.route('/blog')
def blog():
    return send_from_directory('public/pages', 'blog.html')

@app.route('/contact')
def contact():
    return send_from_directory('public/pages', 'contact.html')

@app.route('/chat')
def chat():
    return send_from_directory('public/pages', 'chat.html')

@app.route('/reset-password/<token>')
def reset_password_page(token):
    return send_from_directory('public/pages/auth', 'reset-password.html')
